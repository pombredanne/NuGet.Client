...
# restore packages
echo "dotnet msbuild build/build.proj /restore:false /target:Restore /property:VisualStudioVersion=16.0 /property:Configuration=Release /property:ReleaseLabel=beta /bl:$BUILD_STAGINGDIRECTORY/binlog/02.Restore.binlog"
dotnet msbuild build/build.proj /restore:false /target:Restore /target:Restore /property:VisualStudioVersion=16.0 /property:Configuration=Release /property:ReleaseLabel=beta /bl:$BUILD_STAGINGDIRECTORY/binlog/02.Restore.binlog
...
# Unit tests
echo "dotnet msbuild build/build.proj /restore:false /target:CoreUnitTests /property:VisualStudioVersion=16.0 /property:Configuration=Release /property:ReleaseLabel=beta /bl:$BUILD_STAGINGDIRECTORY/binlog/03.CoreUnitTests.binlog"
dotnet msbuild build/build.proj /restore:false /target:CoreUnitTests /property:VisualStudioVersion=16.0 /property:Configuration=Release /property:ReleaseLabel=beta /bl:$BUILD_STAGINGDIRECTORY/binlog/03.CoreUnitTests.binlog
...
# Func tests
echo "dotnet msbuild build/build.proj /restore:false /target:CoreFuncTests /property:VisualStudioVersion=16.0 /property:Configuration=Release /property:ReleaseLabel=beta /bl:$BUILD_STAGINGDIRECTORY/binlog/04.CoreFuncTests.binlog"
dotnet msbuild build/build.proj /restore:false /target:CoreFuncTests /property:VisualStudioVersion=16.0 /property:Configuration=Release /property:ReleaseLabel=beta /bl:$BUILD_STAGINGDIRECTORY/binlog/04.CoreFuncTests.binlog
